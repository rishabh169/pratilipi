...
const Light =  () =>{
  return(
    <div>
    <h1>its Light</h1>
          <p > If you haven’t watched the first season of Dark and would rather not know what happens in it, turn back now. This post contains spoilers. Like, right after this sentence.</p>
      <p>
